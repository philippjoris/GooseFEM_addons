...
/**
 * @brief Helper function to register common properties of CohesiveMeshBase3d.
 * @tparam C The concrete C++ class (e.g., GooseFEM::MeshCohesive::Hex8::RegularCohesive).
 * @tparam P The pybind11::class_ object for the concrete class.
 */
template <class C, class P>
void register_Mesh_CohesiveBase3d(P& cls)
{
    cls.def_property_readonly("nelx", &C::nelx,
    ...
    cls.def_property_readonly("nelz_lower", &C::nelz_lower,
                              "Get the number of elements in the z-direction for the lower bulk part.");
    cls.def_property_readonly("nelz_upper", &C::nelz_upper,
                              "Get the number of elements in the z-direction for the upper bulk part.");
    cls.def_property_readonly("nnode", &C::nnode,
                              "Get the total number of unique nodes in the mesh.");
    cls.def_property_readonly("ndim", &C::ndim,
                              "Get the spatial dimension of the mesh (e.g., 3 for 3D).");
    cls.def_property_readonly("dofs", &C::dofs,
                              "Get the degrees of freedom for all nodes.");
    cls.def_property_readonly("nne_bulk", &C::nne_bulk,
                              "Get the number of nodes per bulk element.");
    cls.def_property_readonly("nne_cohesive", &C::nne_cohesive,
                              "Get the number of nodes per cohesive element.");
    ...
    cls.def_property_readonly("nodesBottomFace", &C::nodesBottomFace,
                              "Get the global node IDs on the bottom face of the mesh (z = 0).");
    cls.def_property_readonly("nodesTopFace", &C::nodesTopFace,
                              "Get the global node IDs on the top face of the mesh (z = max).");
    cls.def_property_readonly("nodesLeftFace", &C::nodesLeftFace,
                              "Get the global node IDs on the left face of the mesh (x = 0).");
    cls.def_property_readonly("nodesRightFace", &C::nodesRightFace,
                              "Get the global node IDs on the right face of the mesh (x = max).");
    cls.def_property_readonly("nodesFrontFace", &C::nodesFrontFace,
                              "Get the global node IDs on the front face of the mesh (y = 0).");
    cls.def_property_readonly("nodesBackFace", &C::nodesBackFace,
                              "Get the global node IDs on the back face of the mesh (y = max).");
    cls.def_property_readonly("nodesCohesiveLowerInterface", &C::nodesCohesiveLowerInterface,
                              "Get the global node IDs on the lower side of the cohesive interface.");
    cls.def_property_readonly("nodesCohesiveUpperInterface", &C::nodesCohesiveUpperInterface,
                              "Get the global node IDs on the upper side of the cohesive interface.");
    ...
    // Additional useful functions
    cls.def_property_readonly("elementgrid_bulk_lower", &C::elementgrid_bulk_lower,
                              "Get the element numbers of the lower bulk part as a 3D grid.");
    cls.def_property_readonly("elementgrid_bulk_upper", &C::elementgrid_bulk_upper,
                              "Get the element numbers of the upper bulk part as a 3D grid.");
}
